...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { address: @market.address, borough: @market.borough, days_open: @market.days_open, name: @market.name }
    end
  ...
  test "should update market" do
    put :update, id: @market, market: { address: @market.address, borough: @market.borough, days_open: @market.days_open, name: @market.name }
    assert_redirected_to market_path(assigns(:market))
  end
